namespace Sample.FeatureManagement
{
	...
	public static class ConstFeatureFlags
	{
		...
		public const string Beta2 = nameof(Beta2);
		...
		public const string NewBranding = nameof(NewBranding);
		public const string AlternativeColours = nameof(AlternativeColours);

		// These flags are only safe to access from an HttpContext-safe request
		public static class Ui
		{
			const string _prefix = "UI_";
			public const string Beta = _prefix + nameof(Beta);
			public const string NewOnboardingExperiences = _prefix + nameof(NewOnboardingExperiences);
		}
	}
}
